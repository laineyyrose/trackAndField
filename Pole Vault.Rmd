...
From these results for the median, technically the men have a median of exactly one more than women. This does show some sort of 'proof' that their results are better. However, I also wanted to look at the age factor.
